 ...
 */
@interface OMIDIqzoneAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDIqzoneAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDIqzoneAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDIqzoneAdSessionContext *)context
