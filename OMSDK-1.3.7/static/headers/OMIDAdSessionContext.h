 ...
 */
@interface OMIDIqzoneAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDIqzonePartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDIqzonePartner *)partner
                               ...
                               resources:(NSArray<OMIDIqzoneVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
